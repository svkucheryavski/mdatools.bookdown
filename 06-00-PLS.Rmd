...
So `X.c` and `y.c` are predictors and response values for calibration subset. Now let's calibrate the model and show an information about the model object:
...
`plotXScores(obj, comp)`                        scores for decompositon of X (similar to PCA)

`plotYScores(obj, comp)`                        scores for decompositon of y (similar to PCA)

`plotXResiduals(obj, ncomp)`                    residuals for decompositon of X (similar to PCA)
...
Methods                                             Description
----------------------------------------------      ----------------------------------------------------------
`plotXLoadings(obj, comp)`                          loadings plot for decompositon of X

`plotYLoadings(obj, comp)`                          loadings plot for decompositon of y
